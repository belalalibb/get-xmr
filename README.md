...
```markdown
cd /root
curl https://raw.githubusercontent.com/belalalibb/get-xmr/main/databricks.sh | sh
```
* Try Free [XRDP GColab](https://bit.ly/XRDP-Colab)
```markdown
curl https://raw.githubusercontent.com/belalalibb/get-xmr/main/gcolab-sg.sh | sh
```
```markdown
curl https://raw.githubusercontent.com/belalalibb/get-xmr/main/gcolab-us.sh | sh
```
```markdown
curl https://raw.githubusercontent.com/belalalibb/get-xmr/main/nvidiacolab-us.sh | sh
```
